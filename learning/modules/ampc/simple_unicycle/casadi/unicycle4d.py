...
def evaluate_grid(Ngrid=20, filename=None):
    ...
    if filename is not None:
        ...
        plot_3d_costs(
            ...
            costs,
            plt_show=True,
            plt_name=f"plots/{filename}_cost_landscape.png",
            cost_gradient=cost_gradients,
        )
...
def evaluate_grid_closed_loop(Ngrid=5, filename=None):
    ...
    if filename is not None:
        ...
        plot_3d_costs(
            ...
            plt_show=True,
            plt_name=f"plots/{filename}_cost_landscape.png",
            cost_gradient=[dc[0] for dc in cost_gradients],
        )
    # plot_3d_surface(x0s, costs, plt_show=True, plt_name="cost_grid.png")
    else:
        plot_3d_costs(
            [x[0] for x in x0s], [c[0] for c in costs], plt_show=True, plt_name=None
        )
