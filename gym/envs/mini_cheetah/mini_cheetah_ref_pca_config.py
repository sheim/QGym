...
class MiniCheetahRefPcaCfg(MiniCheetahCfg):
    ...
    class scaling(MiniCheetahCfg.scaling):
        pca_scalings = 1 #list(np.load("/home/aileen/QGym/scripts/eigvals.npy"))[0:6]  #[1/6, 1/2, 1/2, 1, 1, 1/2]
...
class MiniCheetahRefPcaRunnerCfg(MiniCheetahRunnerCfg):
    ...
    class policy(MiniCheetahRunnerCfg.policy):
        # actor_hidden_dims = [6, 6, 3]
        # critic_hidden_dims = [6, 6, 3]
