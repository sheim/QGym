...
class MiniCheetahPcaCfg(MiniCheetahCfg):
    class viewer:
        ref_env = 0
        pos = [-2.0, 3, 2]  # [m]
    ...
    class scaling(MiniCheetahCfg.scaling):
        pca_scalings = 0.5  # [6, 2, 2, 1, 1, 2]
        # TODO: n-dim list where n is number of components
        # TODO: scale PCA output by estimated range of component


class MiniCheetahPcaRunnerCfg(MiniCheetahRunnerCfg):
    seed = -1

    class policy(MiniCheetahRunnerCfg.policy):
        disable_actions = False
        actor_hidden_dims = [200, 200, 100]
        critic_hidden_dims = [200, 200, 100]
