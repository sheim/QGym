...
class_dict = {
    ...
    "MiniHorse": ".mini_horse.mini_horse",
...
config_dict = {
    ...
    "MiniHorseCfg": ".mini_horse.mini_horse_config",
...
runner_config_dict = {
    ...
    "MiniHorseRunnerCfg": ".mini_horse.mini_horse_config",
...
task_dict = {
    ...
    "mini_horse": ["MiniHorse", "MiniHorseCfg", "MiniHorseRunnerCfg"],
