...
class_dict = {
    ...
    "HorseOscBelay": ".horse.horse_osc_belay",
...
config_dict = {
    ...
    "HorseOscBelayCfg": ".horse.horse_osc_belay_config",
...
runner_config_dict = {
    ...
    "HorseOscBelayRunnerCfg": ".horse.horse_osc_belay_config",
