...
simple_urdf_name = "./mini_horse_simple.urdf"; % URDF path
...
% Import the URDF
mini_horse_simple = importrobot(simple_urdf_name);
mini_horse_simple.DataFormat = 'column';

% Show the URDF, you have the option to show the colision meshes and/or the visualization mesh
figure(1)
show(mini_horse_simple, config, 'Collisions','on', 'Visuals','off'); title("Simple URDF")
